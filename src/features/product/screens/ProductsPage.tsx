...
// Commenting out the component implementation as requested
...
//     // Redirect to ProductScreen instead of ProductsPage without passing entity ID
//     // to avoid showing specific restaurant/warehouse names
//     (navigation as any).navigate('Product', {
//       screen: 'Products',
//       params: { 
//         category,
//         service
//         // Removed restaurantId/warehouseId to prevent showing specific entity names
//       }
//     });
//   };
